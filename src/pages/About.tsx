        ...
        <div className="relative z-20 container-custom text-center">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="w-20 h-20 mx-auto mb-10 flex items-center justify-center">
              ...
              <img src={logoPng} alt="거상자원 심볼" className="sm:hidden w-full h-full object-contain" />
              <img src={logoSvg} alt="거상자원 심볼" className="hidden sm:block w-full h-full object-contain filter-geosang-teal" />
            </div>
